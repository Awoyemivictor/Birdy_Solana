          ...
          <div className="row">
            <div className="col-lg-4">
              <div className="footer_image">
                ...
                <p>
                Birdy Meme Coin is not just about fun; it's about creating real-world value. Our upcoming 
                features will transform Birdy Coin into a utility coin that combines the appeal of luxury 
                with the practical benefits of blockchain technology. 
